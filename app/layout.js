...
export const metadata = {
  ...
  description:
    "Cabaña en La Falda, Córdoba para hasta 5 personas, con pileta privada, parque, asador y cochera. A 5 cuadras del centro. Reservá por WhatsApp o Booking.",
  keywords: [
    "cabaña en La Falda",
  ...
  openGraph: {
    ...
    description:
      "Cabaña para hasta 5 personas en La Falda, Córdoba. Pileta privada, parque, asador y cochera a 5 cuadras del centro.",
